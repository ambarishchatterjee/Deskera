...
<div id="page" class="site">
    <div class="colorchooser">
        <ul>
            <li id="europe"><img src="<?php echo get_template_directory_uri(); ?>/images/europe.jpg" alt=""></li>
            <li id="singapore"><img src="<?php echo get_template_directory_uri(); ?>/images/singapore.jpg" alt=""></li>
        </ul>
    </div>
            ...
            <div class="site-header-main container">
                    ...
                    <?php else: ?>
                        <?php if (is_front_page() && is_home()) : ?>
                            <h1 class="site-title"><a href="<?php echo esc_url(home_url('/')); ?>"
                                                      rel="home"><img src="<?php echo get_template_directory_uri(); ?>/images/deskera_logo.png"></a></h1>
                        <?php else : ?>
                            <p class="site-title"><a href="<?php echo esc_url(home_url('/')); ?>"
                                                     rel="home"><img src="<?php echo get_template_directory_uri(); ?>/images/deskera_logo.png" alt="Logo"></a></p>
                        <?php endif;
                ...
                <div id="site-header-menu" class="site-header-menu">
                    <nav id="site-navigation" class="main-navigation" role="navigation"
                         aria-label="<?php esc_attr_e('Primary Menu', 'dax'); ?>">
                        <?php
                        wp_nav_menu(array(
